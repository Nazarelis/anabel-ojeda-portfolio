            ...
            <div className="w-full bg-gray-900 relative flex">
                <div className="w-full absolute lg:top-20 lg:left-1/8 top-24 flex flex-col items-center h-auto">
                    <div className="w-auto h-auto flex flex-col animate-slideIn pt-12">
                        <h2 className="text-[#F2BF5E] text-2xl md:text-4xl font-light ">
                            {t('greetingOne')}
                        </h2>
                        <h1 className="text-[#E9E9E9] text-4xl md:text-7xl pb-6 font-medium">
                        {t('greetingTwo')}
                        </h1>
                    </div>
                    ...
                    <div className='flex justify-evenly w-1/2 flex-col items-center animate-slideIn p-8 md:flex-row '>
                    <DownloadButton /> 
